...
5. **Ownership deflated (Burn, 2026-09-02):** "the contractors I brought on to help" → "the contractors that were brought on to help"; "a retention pipeline I designed" → "I helped design." The résumé says "designed and built"; the site claims less. When the résumé and the site disagree, the site is the floor, not the résumé.
6. **Check dates against a source, not a listing:** Burn's App Store listing ID dated from May 2021, but the store's lookup API gave the real first release (2022-06-16), which matched Steve's memory of "about 1.5 years." Verify launch dates with the iTunes lookup API before writing them.
7. **Cut the line that explains what the reader can already see:** "I handed it off when I left in January 2026, and it's still in the store" went; the meta's date range and the live link say the same thing.
8. **Cut what he can't defend out loud (RIDR, 2026-09-02):** "elevation hysteresis" ("I barely know what hysteresis means"), a Maestro end-to-end claim (became "tests, type checks, and lint in CI"), and a Sentry escalation-point story all came out of accurate copy. The agentic pipeline is his personal workflow, so the section is "How I ship", never "we". Evidence proves a thing happened; it doesn't make it his claim.
